...
public class ElytraComponentRender <T extends LivingEntity, M extends BipedModel<T>> extends LayerRenderer<T, M> {
    private final ElytraModel<T> elytraModel = new ElytraModel<>();

    public ElytraComponentRender(IEntityRenderer<T, M> p_i50926_1_) {
        super(p_i50926_1_);
    }
